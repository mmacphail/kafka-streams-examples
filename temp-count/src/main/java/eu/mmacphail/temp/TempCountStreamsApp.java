...
public class TempCountStreamsApp {
  ...
  public static void main(String[] args) {
    ...
    settings.put(StreamsConfig.APPLICATION_ID_CONFIG, "temp-count-streams");
  ...
  private static Topology getTopology() {
    ...
    KTable<String, Long> tempCount = temperatures.groupByKey().count();

    tempCount.toStream().to(
        "temperature-count",
